import { Component, OnInit, Input, OnChanges, ContentChild, TemplateRef, ViewChild } from '@angular/core';
...
@Component({
  selector: 'abstract-template-definition',
  templateUrl: './entity-attributes-new.structure.html'
})
export class AbstractStructureComponent {
  @Input() attrGroup: AttributeGroup;
  @Input() attributes: any[];

  // @ViewChild('attributeForm', { static: false }) attributeForm: NgForm;
  @ContentChild('entitySelection', { static: false }) entitySelection: TemplateRef<any>;
  @ContentChild('addAttribute', { static: false }) addAttribute: TemplateRef<any>;
  @ContentChild('attrGroups_dataTable_header', { static: false }) attrGroups_dataTable_header: TemplateRef<any>;
  @ContentChild('attributes_dataTable_header', { static: false }) attributes_dataTable_header: TemplateRef<any>;
  @ContentChild('dataTable_body_input', { static: false }) dataTable_body_input: TemplateRef<any>;
  @ContentChild('dataTable_body_output', { static: false }) dataTable_body_output: TemplateRef<any>;
  @ContentChild('dataTable_crud', { static: false }) dataTable_crud: TemplateRef<any>;
}

@Component({
  selector: 'app-new-entity-attributegroup',
  templateUrl: './entity-attributes-new.component.html',
  styleUrls: ['./entity-attributes-new.component.css']
})

export class NewEntityAttributeGroupComponent implements OnInit, OnChanges {
  @Input() owner: string;
