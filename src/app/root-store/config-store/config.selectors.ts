...
import { ConfigState, configStoreKey } from './config.state';
...
export const selectConfigsState: MemoizedSelector<object, ConfigState> = createFeatureSelector<ConfigState>(configStoreKey);
